...
const PATH_CAPTURE_START = "__K1CODE_PATH_START__";
const PATH_CAPTURE_END = "__K1CODE_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__K1CODE_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__K1CODE_ENV_${name}_END__`;
}
