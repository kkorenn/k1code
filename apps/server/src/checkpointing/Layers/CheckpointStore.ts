...
import { CheckpointRef } from "@k1tools/contracts";
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "k1-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "K1 Code",
              GIT_AUTHOR_EMAIL: "k1code@users.noreply.github.com",
              GIT_COMMITTER_NAME: "K1 Code",
              GIT_COMMITTER_EMAIL: "k1code@users.noreply.github.com",
            };
            ...
            const message = `k1 checkpoint ref=${input.checkpointRef}`;
