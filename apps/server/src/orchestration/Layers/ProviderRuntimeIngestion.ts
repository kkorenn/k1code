...
import { makeDrainableWorker } from "@k1tools/shared/DrainableWorker";
...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.K1CODE_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
