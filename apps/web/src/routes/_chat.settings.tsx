...
function SettingsRouteView() {
  ...
  return (
    <SidebarInset className="route-transition-enter h-dvh min-h-0 overflow-hidden overscroll-y-none bg-background text-foreground isolate">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between rounded-lg border border-border bg-background px-3 py-2">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Sets the initial diff wrap state when the diff panel opens. The in-panel wrap
                      button only affects the current open diff session.
                    </p>
                  </div>
                  <Switch
