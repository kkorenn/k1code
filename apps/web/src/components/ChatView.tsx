...
export default function ChatView({ threadId }: ChatViewProps) {
  ...
  const providerAvailabilityByProvider = useMemo(
    () => getProviderAvailabilityByProvider(settings, providerStatuses),
  ...
  return (
    <div className="route-transition-enter flex min-h-0 min-w-0 flex-1 flex-col overflow-x-hidden bg-background">
      {/* Top bar */}
      <header
        className={cn(
